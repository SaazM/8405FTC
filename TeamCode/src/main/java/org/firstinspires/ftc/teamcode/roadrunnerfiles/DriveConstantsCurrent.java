...
public class DriveConstantsCurrent {
     ...
     * empirically tuned.
     */
    public static double MAX_VEL = 55.76640180569838; //was 66
    public static double kV = 0.0115; // 0.011522978602550106
    ...
    public static double MAX_ACCEL = 73.17330064499293*0.4;
