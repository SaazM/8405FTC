...
//        auton.runAutonRight();
        ...
        t1 = auton.robot.drive.trajectoryBuilder(new Pose2d())
                ...
                .lineToLinearHeading(new Pose2d(4.5,-57, Math.toRadians(-45)))
        ...
        t1_1 = auton.robot.drive.trajectoryBuilder(t1.end())
                ...
                .lineToLinearHeading(new Pose2d(0, -55, Math.toRadians(180)))
                .addDisplacementMarker(() -> {
                    auton.robot.intake.intake();
       ...
       t2 = auton.robot.drive.trajectoryBuilder(t1_2.end())//2nd cone
               ...
               .addTemporalMarker(1.75, () -> {auton.robot.intake.outtake();})
                .lineToLinearHeading(new Pose2d(16, -52, Math.toRadians(-90)))
        ...
        t3 = auton.robot.drive.trajectoryBuilder(t2_2.end())//2nd cone
                ...
                .lineToLinearHeading(new Pose2d(16, -52.5, Math.toRadians(-90)))
        ...
        t4 = auton.robot.drive.trajectoryBuilder(t3_2.end())//2nd cone
                .addDisplacementMarker(() -> currLift = 1)
                .addTemporalMarker(1.75, () -> {auton.robot.intake.outtake();})
                .lineToLinearHeading(new Pose2d(15, -52.5, Math.toRadians(-90)))
