...
public class AutonAsync extends OpMode
{
    ...
    Trajectory t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13;
    ...
    public void runAutonHighSpamRight() {
        ...
        t11 = robot.drive.trajectoryBuilder(t10.end())
                .lineToLinearHeading(new Pose2d(t10.end().getX(), t10.end().getY()+13, Math.toRadians(180)))
                .addDisplacementMarker(() -> robot.drive.followTrajectoryAsync(t12))

                .build();

        t12 = robot.drive.trajectoryBuilder(t12.end())
                .forward(22)
                .addDisplacementMarker(() ->
